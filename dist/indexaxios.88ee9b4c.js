...
var _indexaxios = require("./indexaxios.js");
function _getRequireWildcardCache(e) { if ("function" != typeof WeakMap) return null; var r = new WeakMap(), t = new WeakMap(); return (_getRequireWildcardCache = function (e) { return e ? t : r; })(e); }
function _interopRequireWildcard(e, r) { if (!r && e && e.__esModule) return e; if (null === e || "object" != typeof e && "function" != typeof e) return { default: e }; var t = _getRequireWildcardCache(r); if (t && t.has(e)) return t.get(e); var n = { __proto__: null }, a = Object.defineProperty && Object.getOwnPropertyDescriptor; for (var u in e) if ("default" !== u && {}.hasOwnProperty.call(e, u)) { var i = a ? Object.getOwnPropertyDescriptor(e, u) : null; i && (i.get || i.set) ? Object.defineProperty(n, u, i) : n[u] = e[u]; } return n.default = e, t && t.set(e, n), n; }
function createCarouselItem(imgSrc, imgAlt, imgId) {
  ...
  favBtn.addEventListener("click", function () {
    (0, _indexaxios.favourite)(imgId).then(function () {
...
},{"bootstrap":"node_modules/bootstrap/dist/js/bootstrap.esm.js","./indexaxios.js":"indexaxios.js"}],"node_modules/axios/lib/helpers/bind.js":[function(require,module,exports) {
'use strict';
...
exports.Axios = Axios;
},{"./lib/axios.js":"node_modules/axios/lib/axios.js"}],"indexaxios.js":[function(require,module,exports) {
"use strict";
...
var API_KEY = "live_mOHUcCotszCsSkshqfvDD7BzIEpWdHxzAtpAtnafEtVW6pJaToOuym1u88Yatapm";
...
_axios.default.interceptors.response.use(function (response) {
  var duration = new Date() - response.config.time.startTime;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 6:
          ...
          _context2.next = 12;
          return handleBreedSelect(initialBreedId);
        case 12:
          _context2.next = 17;
          break;
        case 14:
          ...
          console.error("Error Fetching breeds failed", _context2.t0);
        case 17:
        case "end":
...
function _handleBreedSelect() {
  _handleBreedSelect = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(breedId) {
    var response, images, mala, malaData, breed, infoItem;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return _axios.default.get("/images/search?limit=5&breed_ids=".concat(breedId), {
            onDownloadProgress: updateProgress
          });
        case 3:
        ...
        case 24:
          ...
          infoItem.innerHTML = "\n    <h1>".concat(breed.name, "</h1>\n    <p>").concat(breed.description, "</p>\n    <p><strong>Temperament:</strong> ").concat(images[0].breeds[0].temperament, "</p>\n    <p><strong>Origin:</strong> ").concat(images[0].breeds[0].origin, "</p>");
          infoDump.appendChild(infoItem);
          images.forEach(function (imgData, index) {
            var carouselItem = (0, _Carousel.createCarouselItem)(imgData.url, imgData.breeds[0].name, imgData.id);
        ...
        case 31:
          ...
          console.error("Error Fetching breed info. failed", _context3.t0);
        case 34:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return handleBreedSelect(breedId);
        case 3:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 20:
          ...
          console.error("Error toggling favourite failed", _context4.t0);
          throw _context4.t0;
        case 24:
        case "end":
      ...
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 3:
          ...
          favourites.forEach(function (fav) {
            var carouselItem = (0, _Carousel.createCarouselItem)(fav.image.url, "FavouriteImage", fav.image_id);
            console.log('success');
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","indexaxios.js"], null)
//# sourceMappingURL=/indexaxios.88ee9b4c.js.map